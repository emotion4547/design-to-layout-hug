...
const deliveryZones = [
  ...
  },
  {
    ...
    description: 'Мы осуществляем доставку по всему Сергиево-Посадскому городскому округу, стоимость зависит от суммы заказа и удалённости.',
    price: 'от 200 ₽',
  },
  {
    icon: CheckCircle,
...
const deliveryDetails = [
  'Доставка осуществляется ежедневно с 9:15 до 21:00',
          ...
          <div className="aspect-[16/9] md:aspect-[21/9] bg-secondary/50 rounded-lg flex items-center justify-center">
            <div className="text-center p-8">
              ...
              <p className="text-muted-foreground mb-4">
                Доставка по г. Сергиев Посад и Сергиево-Посадскому городскому округу
              </p>
