...
const ContactsPage = () => {
  ...
  return (
    <PageLayout>
      <SEO
        title="Контакты"
        description="Контактная информация магазина Везу букет в Новороссийске. Телефон, адрес, режим работы. Оставьте отзыв о нашей работе."
        keywords="контакты Везу букет, цветочный магазин Новороссийск, доставка цветов телефон, адрес магазина цветов"
        url="/contacts"
      />
      ...
      <section className="py-12 md:py-16 bg-background">
        <div className="container">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl">
            Везу букет — лучший сервис доставки цветов в Новороссийске
          </p>
        </div>
      </section>
