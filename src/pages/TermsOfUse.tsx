      ...
      <section className="py-12 md:py-16">
        <div className="container">
          ...
          <div className="prose prose-lg max-w-none text-foreground/80">
            ...
            <p className="mb-4">
              Настоящее Пользовательское соглашение (далее — «Соглашение») регулирует отношения между ИП Момонт Регина Валерьевна (далее — «Продавец») и пользователем сайта vezubuket23.ru (далее — «Покупатель»).
            </p>
            <p className="mb-4">
            ...
            <p className="mb-4">
              Продавец осуществляет продажу цветов, букетов, подарков и сопутствующих товаров через интернет-магазин vezubuket23.ru. Покупатель имеет возможность ознакомиться с ассортиментом, оформить заказ и получить товар.
            </p>
