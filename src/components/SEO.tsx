...
const DEFAULT_DESCRIPTION = 'Доставка свежих цветов и букетов в Новороссийске. Авторские композиции, съедобные букеты, подарки. Быстрая доставка по городу.';
...
export const SEO = ({
  ...
  const fullTitle = title ? `${title} | ${SITE_NAME}` : `${SITE_NAME} — Доставка цветов и букетов в Новороссийске`;
