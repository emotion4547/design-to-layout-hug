...
export const QuizPopup = () => {
  ...
  const handleFinish = () => {
    if (!agreed) return;
    // Here you could save data to Supabase
    console.log('Quiz data:', { name, phone, birthday, importantDate, recipientName });
    setSubmitted(true);
  };
            ...
            <div className="bg-gradient-to-br from-primary/10 via-primary/5 to-transparent p-6 pb-4">
              ...
              {step === 2 && (
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Мы напомним, чтобы вы не забыли поздравить
                  </p>
                </div>
              )}
              {step === 3 && (
              ...
              {step === 2 && (
                <div className="space-y-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input
                      id="quiz-recipient"
                      placeholder="Кого будем поздравлять?"
                      value={recipientName}
